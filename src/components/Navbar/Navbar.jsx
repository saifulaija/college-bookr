...
const Navbar = () => {
  ...
  const navItem = (
    <>
      <li>
        <NavLink exact to="/" className="text-white flex items-center">
          Home
        </NavLink>
      </li>
      <li>
        <NavLink to="/college" className="text-white flex items-center">
          Colleges
        </NavLink>
      </li>
      <li>
        <NavLink to="/admission" className="text-white flex items-center">
          Admissions
        </NavLink>
      </li>
      <li>
        <NavLink to="/my-college" className="text-white flex items-center">
          My Colleges
        </NavLink>
      </li>
      {user ? (
